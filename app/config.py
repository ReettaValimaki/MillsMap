...
mill_columns = 'coordinatesDescription_coodinates_coordinates,start,end,interviewee_details-interviewee_role,interviewee_details-date_of_interview,school_details-school_name,school_details-school_type,school_details_Location-addr_region,\
